...
class fm_station101o9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_station101o9")
        ...
        self._freq_range = qtgui.Range(88e6, 107.9e6, 200e3, 101.9e6, 200)
...
def main(top_block_cls=fm_station101o9, options=None):
